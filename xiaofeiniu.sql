...
(NULL,'admin',PASSWORD('123456')),/*PASSWORD用来加密密码使用*/
...
(NULL, '椎茸', '1.jpg', '36', '经过清洗、切配、装盘而成。锅开后再煮4分钟左右即可食用', '5'),
(NULL, '竹荪', '3.jpg', '29', '野生竹荪，口感爽滑、脆嫩，开锅后煮3分钟左右即可食用', '5'),
(NULL, '香菇', '2.jpg', '24', '经过挑选、清洗、切配、装盘而成。锅开后再煮5分钟左右即可食用', '5'),
(NULL, '金针菇', '4.jpg', '28', '经过挑选、清洗、装盘而成。菌盖滑嫩、清脆，锅开后再煮2分钟左右即可食用', '5');
